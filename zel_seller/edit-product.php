						...
						<div class="row">                          
						  <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="select-arrowreg">
                                <select name="residue_free_check" class="form-control" onChange="changeresidue(this)" required>
								  <option value="">Select</option>
						  ...
						  <div class="col-md-4" id="residue_result_div" style="display:show;">
                            <div class="form-group">
						  ...
						  <div class="col-md-4" id="global_gap_div" style="display:show;">
                            <div class="form-group">
