...
$show="display:none;";
$alert="";
	$sqlcnt="SELECT COUNT(*)AS count FROM product WHERE sid=$sid AND status!=0";
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 col-md-12">
        <h2 class="page-title remove-top-padding">My Products</h2>
        <div class="row">
		...
		<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
         ...
         <div class="panel panel-info light-pink">
              <div class="panel-heading">
				...
				<span class="badge pull-right"><?php echo $count; ?></span>My Products</h3>
              </div>
              <div class="panel-body remove-padding remove-border">
<?php
$sqlcnt = "SELECT * FROM product WHERE sid=$sid AND status!=0";
$resultcnt = $conn->query($sqlcnt);
...
$sql = "SELECT * FROM product p WHERE p.sid=$sid AND p.status!=0 ORDER BY p.pid DESC $limit";
                  ...
                  <div class='profile-search-list-box'>
                    <div class='row'>
					  ...
					  <video id='video1' width='250' controls>
						<source src='./".$row['vdopath']."' type='video/mp4'>
						<source src='./".$row['vdopath']."' type='video/ogg'>
					  ...
					  echo"<button class='btn btn-default'>Highest Bid Amount: <b>Rs. ".$highest_amount."</b></button>	
					  </div>
