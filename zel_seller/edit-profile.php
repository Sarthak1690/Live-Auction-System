...
if (isset($_POST['persdtlsub'])){
   	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		$address = test_input($_POST["address"]);
          $sql = "UPDATE seller SET sname='$sname', email='$email',city='$city', taluka='$taluka', dist='$dist', pincode='$pincode', address='$address' WHERE sid=$sid";
...
if (isset($_POST['submitphoto'])){
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		if($filecount>3)
		{
			$error="Only 3 Files are allowed!";
			$show="display:show;";
			$alert="alert alert-danger";
		}
		else if(!isset($_FILES['otherfile']))
		{
		...
		header( "Refresh:1; url=./edit-profile.php?alert=$alert&show=$show&error=$error", true, 303);
	}
}
			...
			if(is_uploaded_file($_FILES['otherfile']['tmp_name'][$i])) {    
				if( $_FILES['otherfile']['size'][$i] < $maxsizeimg) {  
					...
					if(strpos(finfo_file($finfo, $_FILES['otherfile']['tmp_name'][$i]),"image")===0) {
						...
						$newfilename = $sid."_".$i."_".date("Ymdhis").'.' . end($temp);
						move_uploaded_file($_FILES['otherfile']['tmp_name'][$i],"./uploads/docs_images/".$newfilename);
						$imgpath="/uploads/docs_images/".$newfilename;
						$sql = "INSERT INTO seller_doc (imgpath, photo_date, photo_status, sid)VALUES ('$imgpath', '$currdate',1, $sid)";  
						if($conn->query($sql)===TRUE){
		    ...
		    <div class="panel panel-info light-pink">
              ...
              <div class="panel-body">
        		...
        		<li class="nav-item active">
        			<a href="#personal" class="nav-link active" role="tab" data-toggle="tab">Personal Details</a>
        		</li>
				<li class="nav-item">
				...
				<div class="tab-content">
                  <div class="row well tab-pane fade in active" role="tabpanel" id="personal">
                    <div class="col-lg-12">
					<form method="post" onsubmit="return validation()" name="editprofile" id="editprofile" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                      <div class="profile-subhead">
                        ...
                        <div class="row">
                          <div class="col-md-6">
				            ...
				            <input type="text" class="form-control" id="sname" name="sname" value="<?php echo $sname; ?>" onkeyup="" required>
                         ...
                         <input name="dist" type="text" id="dist" class="form-control" value="<?php echo $dist; ?>" required>
                          ...
                          <div class="col-md-6">
						   ...
						   <div class="col-md-6">
                            <div class="form-group">
                              <label>Address</label>
								<textarea rows="3" name="address" type="text" id="address" class="form-control" required><?php echo $address; ?></textarea>
							</div>
                          </div>
                    ...
                    <div class="col-lg-12">					
                      <div class="profile-subhead">
						<div class="row" id="profile-picture-upload">
							<p>You can attached your Aadhar Card Photo copy! (only 3 files are allowed!)</p><br/>
							<?php
							  $sql1 = "SELECT * FROM seller_doc WHERE sid=$sid AND photo_status=1";
								...
								while($row = $result->fetch_assoc()) {
									echo"<div class='col-xs-6 col-sm-6 col-md-3 col-lg-3'>
											<div class='profile-img-gallery'>
												...
												<button type='button' onclick='delete_doc(".$row['sdoc_id'].")' class='btn  btn-xsmall btn-pink-outline' name='del_photo' id='del_photo'>Delete Image <i class='fa fa-times'></i></button>
											</div>
										</div>";
								}
							  }
						...
						<form enctype="multipart/form-data" data-toggle="validator" method="post" name="edit-product-photo" id="edit-product-photo" action="./edit-profile.php?sid=<?php echo $sid;?>">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
