  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 col-md-12">
        <h2 class="page-title remove-top-padding">Bank Details</h2>
        <div class="row">
         <?php
           ...
           <div class="col-sm-8 col-md-9 col-lg-9">
            <div class="panel panel-info light-pink">
              ...
              <div class="panel-body">
               <h4><b>Account Name:</b> Online Auction System <br/>
						<b>Account No:</b> 000000000000 <br/>
						<b>IFSC Code:</b> SBIN000000 <br/>
						<b>Branch Name:</b> Manchar <br/>
				</h4>
                </div>
              </div>
            </div>
