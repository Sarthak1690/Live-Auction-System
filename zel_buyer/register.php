        ...
        <h2 class="page-title">New Registration</h2>
				...
				<h2 class="panel-title"> नियम व अटी : </h2>
					<table class="table" border="1">
						...
						<tr>
							<td class="odd">2.</td>
							<td class="even">व्यापाऱ्याला लिलावात भाग घेण्यासाठी अनामत म्हणून ५००० रु ऑनलाईन  जमा करावे लागतील. लिलावानंतर सदर रकमेतून १००० रु. रेजिस्ट्रेशन फी वगळता इतर रक्कम परत केली जाईल. ज्या व्यापाऱ्याला रोज लिलावात सहभाग घ्यायचा आहे त्यांनी सदर रक्कम जमा ठेवणे आवश्यक आहे.</td>
						</tr>
						<tr>
							<td class="odd">3.</td>
							<td class="even">ज्या साईझच्या मालाची माहिती लिलावासाठी दिली आहे त्याच साईझचा माल शेतकरी हार्वेस्टिंग करून पॅक करून देणार आहे.</td>
						</tr>
						<tr>
							<td class="odd">4.</td>
							<td class="even"> व्यापाऱ्याने निवडलेल्या पॅकिंग प्रमाणे शेतकऱ्याने माल पॅक  करून व्यापाऱ्याची गाडी भरून द्यावयाची आहे. पॅकिंगला येणाऱ्या खर्चा प्रमाणे संस्थेने जे आदर्श पॅकिंग खर्च ठरवले आहेत त्याप्रमाणे व्यापाऱ्याकडून शेतकऱ्याला मालाच्या किंमतीबरोबर पॅकिंग खर्च दिला जाईल. </td>
						</tr>
						<tr>
							<td class="odd">5.</td>
							<td class="even">लिलाव झाल्यानंतर १५ ते २५ टक्के रक्कम संस्थेत जमा केल्यानंतर मालाची काढणी पॅकिंग चालू होईल व संपूर्ण पेमेंट केल्यानंतर माळ ताब्यात दिला जाईल. वाहतूक व्यापाऱ्याने करावयाची आहे. मालाच्या संख्येनुसार संस्थेला सर्व्हिसचार्ज द्यावा लागेल.</td>
						</tr>						
						<tr>
							<td class="odd">7.</td>
							<td class="even">जर व्यापाऱ्याने लिलाव घेऊनही माळ घेतला नाही तर शेतकऱ्याला नुकसान भरपाई म्हणून व्यापाऱ्याची अनामत असलेली रक्कम अदा केली जाईल. व त्याला ब्लॉक लिस्ट केले जाईल. तसेच शेतकऱ्याने जर लिलाव रद्द  केला तर शेतकऱ्याची अनामत म्हणून जमा असलेली ४००० रु. संस्था व्यापाऱ्याला अदा करेल.  </td>
						</tr>
						<tr>
							<td class="odd">8.</td>
   ...
   <div class="row">
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12" style="margin-top:10px;">
        <h2 class="page-title remove-top-padding">Buyer Registration</h2>
        <div class="row">
			  ...
			  <div class="row">
				...
				<div class="col-sm-6 col-md-6">                
				  ...
				  <label class="control-label" >Company Mobile<span class="red">*</span></label>
                   <input type="text" class="form-control" name="comp_mob" id="comp_mob" required/>
				</div>
				</div>                	
			 </div>
			 <div class="row">                
				<div class="col-sm-6 col-md-6">                
				  ...
				  <label class="control-label" >Company Type<span class="red">*</span></label>
                   <input type="text" class="form-control" name="comp_type" id="comp_type" required/>
				</div>
				</div>
				<div class="col-sm-6 col-md-6">                
                  <div class="form-group">
				  <label class="control-label" >Company Product<span class="red">*</span></label>
                   <input type="text" class="form-control" name="comp_prod" id="comp_prod" required/>
				</div>
				</div>                	
			 </div>			 
			  <div class="row">
                 ...
                 <div class="col-sm-6 col-md-6">
					<div class="form-group">
						<label>Upload Aadhar Card Or Company Certificate<span class="red">*</span></label>
