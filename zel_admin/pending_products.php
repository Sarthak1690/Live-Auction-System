...
$show="display:none;";
$alert="";
	$sqlcnt="SELECT COUNT(*)AS count FROM product WHERE status=2";
...
<?php
$sqlcnt = "SELECT * FROM product WHERE status=2";
$resultcnt = $conn->query($sqlcnt);
...
$sql = "SELECT * FROM product p WHERE p.status=2  ORDER BY p.pid DESC $limit";
