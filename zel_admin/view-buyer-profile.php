...
<title>Buyer Profile View </title>
					...
					while($row = $result->fetch_assoc()) {
						echo"<div class='col-xs-6 col-sm-6 col-md-3 col-lg-3'>
								<div class='profile-img-gallery'>
									<img src='../zel_buyer".$row['imgpath']."' style=height:150px;width:400px' class='img-thumbnail img-responsive'>
									<button type='button' onclick='delete_buyer_doc(".$row['doc_id'].")' class='btn  btn-xsmall btn-pink-outline' name='del_photo' id='del_photo'>Delete Image <i class='fa fa-times'></i></button>
								</div>
							</div>";
					}
				  }
