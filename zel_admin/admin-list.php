...
$show="display:none;";
$alert="";
	$sqlcnt="SELECT COUNT(*)AS count FROM user WHERE status=1";
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 col-md-12">
        <h2 class="page-title remove-top-padding">Admin List</h2>
        <div class="row">
		...
		<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
         ...
         <div class="panel panel-info light-pink">
              <div class="panel-heading">
				...
				<span class="badge pull-right"><?php echo $count; ?></span>Admin List</h3>
              </div>
              <div class="panel-body remove-padding remove-border">
<?php
$sqlcnt = "SELECT * FROM user WHERE status=1";
$resultcnt = $conn->query($sqlcnt);
...
$sql="SELECT * FROM user WHERE status=1 ORDER BY uid DESC $limit";
                  ...
                  <div class='profile-search-list-box'>
                    <div class='row'>
                      ...
                      <div class='col-sm-8 col-md-8 col-lg-8'>
                        <p class='profile-user-name'><a href='#'>".$row['uname']."</a> <span class='profile-user-id'>".$row['uid']."</span></p>
                        <div class='row'>
                   ...
                   echo" <div class='row top-border'>
                      <div class='col-md-12'>
                        <div class='btn-group btn-group-md profile-group-btn'>                          
                          <button onclick='delete_admin(".$row['uid'].")' class='btn btn-default pink2-btn btn-on'><i class='fa fa-trash-o'></i>Delete</button>						  
						</div>
                      </div>
                    </div>
                  </div>
