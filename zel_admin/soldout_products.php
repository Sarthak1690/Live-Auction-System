...
$show="display:none;";
$alert="";
	$sqlcnt="SELECT COUNT(*)AS count FROM product WHERE status=3";
...
<?php
$sqlcnt = "SELECT * FROM product WHERE status=3";
$resultcnt = $conn->query($sqlcnt);
...
$sql = "SELECT * FROM product p WHERE p.status=3  ORDER BY p.pid DESC $limit";
