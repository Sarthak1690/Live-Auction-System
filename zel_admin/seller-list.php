...
$show="display:none;";
$alert="";
	$sqlcnt="SELECT COUNT(*)AS count FROM seller WHERE status=1";
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 col-md-12">
        <h2 class="page-title remove-top-padding">Seller List</h2>
        <div class="row">
		...
		<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
         ...
         <div class="panel panel-info light-pink">
              <div class="panel-heading">
				...
				<span class="badge pull-right"><?php echo $count; ?></span>Seller List</h3>
              </div>
              <div class="panel-body remove-padding remove-border">
<?php
$sqlcnt = "SELECT * FROM seller WHERE status=1";
$resultcnt = $conn->query($sqlcnt);
...
$sql="SELECT * FROM seller s, seller_deposit sd WHERE s.sid=sd.sid AND s.status=1 ORDER BY s.sid DESC $limit";
                  ...
                  <div class='profile-search-list-box'>
                    <div class='row'>
                      ...
                      <div class='col-sm-8 col-md-8 col-lg-8'>
                        <p class='profile-user-name'><a href='/view-seller-profile.php?sid=".$row['sid']."'>".$row['sname']."</a> <span class='profile-user-id'>".$row['sid']."</span></p>
                        <div class='row'>
                   ...
                   echo" <div class='row top-border'>
                      <div class='col-md-12'>
                        <div class='btn-group btn-group-md profile-group-btn'>                          
                          <a href='view-seller-profile.php?sid=".$row['sid']."' type='button' class='btn btn-default pink2-btn btn-on'><i class='fa fa-eye'></i>View</a>
                          <button onclick='delete_seller(".$row['sid'].")' class='btn btn-default pink2-btn btn-on'><i class='fa fa-trash-o'></i>Delete</button>";
						  if($row['paystatus'] == 1)
							{
								echo"<a href='seller_getpaid.php?sid=".$row['sid']."' type='button' class='btn btn-success pink2-btn btn-on'><i class='fa fa-thumbs-up'></i>Paid User</a>";						  
							}
							else
							{
								echo"<a href='seller_getpaid.php?sid=".$row['sid']."' type='button' class='btn btn-danger pink2-btn btn-on'><i class='fa fa-thumbs-up'></i>Unpaid User</a>";						  
							}
