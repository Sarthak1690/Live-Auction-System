  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 col-md-12">
        <h2 class="page-title remove-top-padding">View Seller Profile</h2>
		<div class="row">
           <?php
              ...
              <div class="panel-body">
                <div class="row">
                  ...
                  <div class="profile-sumup">
                    <p class="profile-user-name"><a href="#"><?php echo $sname; ?></a> <span class="profile-user-id"><?php echo $sid; ?></span></p>
                    <div class="row">
                      <div class="col-lg-6">
					...
					while($row = $result->fetch_assoc()) {
						echo"<div class='col-xs-6 col-sm-6 col-md-3 col-lg-3'>
								<div class='profile-img-gallery'>
									...
									<button type='button' onclick='delete_seller_doc(".$row['sdoc_id'].")' class='btn  btn-xsmall btn-pink-outline' name='del_photo' id='del_photo'>Delete Image <i class='fa fa-times'></i></button>
								</div>
							</div>";
					}
				  }
  ...
  <button class="btn btn-primary" title="Back to Top"><i class="fa fa-angle-up"></i></button>
     ...
     <div  id="invoice"  style="border:1px solid #ccc; padding:10px; height:100%; width:590pt; display:none;">
		...
		<div style="text-align:center; border:0px solid #ccc; float:right; width:510px;">
          ...
          <tbody>
			<tr>
              <td colspan="2" style='text-align:left; font-size:15px; font-style:bold; padding: 0px; border-bottom: 1px solid;'><b><?php echo $sname; ?></b></td>
			  ...
			  <td  style='text-align:left; font-size:15px; font-style:bold;  padding: 0px; border-bottom: 1px solid;'> <span>:</span> <b><?php echo $sid; ?></b></td>
			</tr>
			<tr>
...
<div  id="receipt"  style="border:1px solid #ccc; padding:10px; height:100%; width:590pt; display:none;">
        ...
        <div style="text-align:center; border:0px solid #ccc; padding-top:20px;  float:center; width:100%;">
         ...
         <h4 align="center"> Seller Payment Receipt</h4><hr/>
          ...
          <tbody>
		  	<tr>
              <td style='text-align:left;  padding: 3px; border-bottom: 1px solid;'>Seeler Id</td>
